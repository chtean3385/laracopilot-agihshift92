...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'pgsql' => [
            'driver' => 'pgsql',
            // DATABASE_URL is auto-provided by Replit's Production Database (includes password).
            // In dev it points to the local DB; in prod it points to the Neon production DB.

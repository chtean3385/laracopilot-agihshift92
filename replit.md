...
| 2026-05-14 | v1.0.14 | `pending` | GST-inclusive pricing shown throughout app: booking create price summary (live JS), room dropdown, room card, rooms search, booking detail Rate/Night |

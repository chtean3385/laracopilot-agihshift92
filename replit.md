...
| 2026-06-04 | v1.0.35 | `pending` | Fix: nginx SCRIPT_FILENAME uses $document_root instead of $realpath_root — on Replit Reserved VM the workspace path is a symlink so $realpath_root resolved to a path PHP-FPM rejected with 403. |

...
| 2026-06-05 | v1.0.38 | `pending` | Complete dark navy/gold color scheme redesign: all view files converted to #1a2332 dark navy + #c9a96e gold accents. Preserved green (#22c55e) for available/check-in status and red (#f43f5e/#dc2626) for errors/occupied. Livewire components, error pages (404/403), installer, bookings, rooms, invoices, restaurant, settings, and activity log all themed. Inline styles used throughout due to Tailwind CDN limitation. |

            ...
            <div id="aqmWaSection">
                ...
                <div style="display:flex;flex-direction:column;gap:8px;margin-bottom:16px;">
                    ...
                    <div id="aqm-tpl-{{ $tplKey }}"
                        data-tpl-name="{{ e($tpl['meta_name']) }}"
                        data-tpl-lang="{{ e($tpl['language']) }}"
                        onclick="analyticsSelectTpl('{{ $tplKey }}')"
                        ...
                        <div style="font-size:11px;color:#64748b;line-height:1.5;">{{ $tplPreviewText }}</div>
                    </div>
                    @endforeach
                </div>
...
window.analyticsSelectTpl = function(key) {
    ...
    if (el) {
        el.style.border = '2px solid #25d366'; el.style.background = '#f0fdf4';
        window._aqmTplName = el.dataset.tplName;

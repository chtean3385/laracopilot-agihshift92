    ...
    <div class="invoice-wrap bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div class="p-4 sm:p-8">
            ...
            <table class="w-full mb-6 border border-gray-200 min-w-[420px]">
                ...
                <tbody>
                    @php
                        $prtIsWH = (bool) $invoice->booking->is_whole_hotel;
                        $prtExtraTotal = $invoice->booking->extraCharges->sum('total_price');
                        if ($prtIsWH || $invoice->booking->price_overridden) {
                    ...
                    <tr class="border-t border-gray-200">
                        ...
                        <td class="px-4 py-3 text-sm text-right">
                            @if($prtIsWH || $invoice->booking->price_overridden)₹{{ number_format($prtRoomCost) }}@else₹{{ number_format($invoice->booking->room?->price_per_night ?? 0) }}@endif
                        </td>

...
class HotelController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        DB::transaction(function () use ($data, $slug, $trialDays, $planExpiresDays, $existingUser) {
            ...
            $modules = [
                ...
                // Task #111 — Standalone Food Menu module is dormant.
    ...
    private function provisionRoles(int $hotelId): void
    {
        $allSlugs = [
            ...
            'whatsapp.send',
            // Task #111 — food_menu.* permissions kept dormant (module disabled).
        ...
        if (!empty($missingSlugs)) {
            $permLabels = [
                ...
                // Task #111 — food_menu.* labels kept dormant (module disabled).
